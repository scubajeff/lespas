        ...
        if (changedAlbums.isNotEmpty()) {
            ...
            for (changedAlbum in changedAlbums) {
                ...
                remotePhotoList.forEach { remotePhoto ->
                    if ((remotePhoto.contentType.startsWith("image/", true) && remotePhoto.contentType.substringAfter('/') in setOf("jpeg", "png", "gif", "webp", "bmp", "heic")) || remotePhoto.contentType.startsWith("video/", true)) {
